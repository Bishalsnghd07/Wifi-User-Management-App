...
// import { ShieldCheck, FileCheck, UploadCloud, ArrowLeft } from "lucide-react";
...
//     try {
//       // Mock KYC Upload call
//       const res = await fetch("/api/kyc", {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({
//           userId: "mock-user-id", // Handled seamlessly on backend
//           docType,
//           docUrl: "https://example.com/verified-doc.pdf",
//         }),
//       });
...
//         <div>
//           <div className="w-12 h-12 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center justify-center text-emerald-400 mb-3">
//             <ShieldCheck className="w-6 h-6" />
//           </div>
//           <h1 className="text-xl font-bold">KYC Identity Verification</h1>
//           <p className="text-xs text-slate-400 mt-1">
//             Government regulatory compliance for guest network connectivity
//           </p>
//         </div>
...
//                 <option value="Aadhaar">Aadhaar Identity Proof</option>
//                 <option value="Passport">Passport</option>
//                 <option value="CorporateID">Corporate Employee Badge</option>
//               </select>
//             </div>
...
//               </label>
//               <label className="border-2 border-dashed border-slate-800 hover:border-blue-500/50 bg-slate-950/50 rounded-xl p-6 flex flex-col items-center justify-center cursor-pointer transition-colors">
...
//               type="submit"
//               disabled={loading}
//               className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-medium py-3 rounded-xl transition-all shadow-lg shadow-emerald-600/20"
//             >
